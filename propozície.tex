...
%	\zvyraznenyDvojriadok{Miesto}{Pekná cesta nad Horárňou Krasňany}
	...
	\zvyraznenyDvojriadok{Doprava}{
		...
		\begin{uzsiaTabulka}
			\dvojriadok{\quad	MHD:}{Autobus č.~154 zo zástavky Hubeného, prvý spoj 9:07, potom každých 30~minút.}
			\dvojriadok{\quad Autom:}{Po Horáreň Krasňany, parkovanie pozdĺž ulice.}
		\end{uzsiaTabulka}
	}
